...
import sing.imageloader.GlideImageLoader;
import sing.imageloader.PicassoImageLoader;
import sing.imageloader.UILImageLoader;
import sing.imageloader.XUtils3ImageLoader;
...
import sing.wxdemo.WxDemoActivity;
...
public class MainActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener, CompoundButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((CheckBox)findViewById(R.id.cb_show_camera)).setOnCheckedChangeListener(this);//相机
        ((CheckBox) findViewById(R.id.cb_crop)).setOnCheckedChangeListener(this);//裁剪
        ((CheckBox) findViewById(R.id.cb_isSaveRectangle)).setOnCheckedChangeListener(this);
